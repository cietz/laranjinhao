...
export function middleware(req) {
  ...
  // Debug: log para verificar se middleware está rodando
...
export const config = {
  // Protege TODAS as páginas exceto /blog, api e arquivos estáticos
  matcher: [
    /*
     ...
     * - blog (página de bloqueio)
     * - public folder files
     */
    "/((?!api|_next/static|_next/image|favicon.ico|blog|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico)$).*)",
  ],
};
